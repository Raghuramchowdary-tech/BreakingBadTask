...
val mockBreakingBadCharacter = BreakingBadCharacter(
    char_id = 1,
    name = "Walter White",
    birthday = "09-07-1958",
...
val mockBreakingBadCharacter2 = BreakingBadCharacter(
    char_id = 4,
...
val mockBreakingBadCharacterSeason3 = BreakingBadCharacter(
    char_id = 5,
    name = "Test Name",
    birthday = "07-08-1973",
...
val mockBreakingBadCharacterSeason1AndSeason2 = BreakingBadCharacter(
    char_id = 5,
    name = "Test Name",
    birthday = "07-08-1973",
    occupation = listOf("Professor"),
